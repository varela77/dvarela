...
namespace Win.Tienda
{
    public partial class FormFactura : Form
    {
        ...
        public FormFactura()
        {
            ...
            _modelosBL = new ModeloBL();
            listaModelosBindingSource.DataSource = _modelosBL.ObtenerModelos();
        }
        ...
        private void bindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
            if (idTextBox.Text != "")
            {
                var resultado = MessageBox.Show("Desea anular está factura?", "Anular", MessageBoxButtons.YesNo);
